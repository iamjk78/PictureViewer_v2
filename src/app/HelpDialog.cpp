...
void HelpDialog::showAbout(QWidget *parent)
{
    ...
    const QString html = QString(
        ...
        "<h3>Funkce</h3>"
        "<ul>"
        "<li><b>Procházení obrázků</b> — panel náhledů se všemi obrázky ve složce</li>"
        "<li><b>Slideshow</b> — automatická prezentace s nastavitelným intervalem (1–60 sekund)</li>"
        "<li><b>Přiblížení/oddálení</b> — kolečkem myši nebo gesty trackpadu</li>"
        ...
        "<li><b>Přejmenování obrázků</b> — přímo z aplikace pomocí tlačítka nebo klávesy R</li>"
        "<li><b>Odstranění/přesunutí</b> — smazání nebo přesunutí do složky Delete (se potvrzením)</li>"
        "<li><b>Přehrávání videa</b> — podpora MP4, MOV, WebM a dalších formátů přes VLC</li>"
        "<li><b>Metadata</b> — zobrazení informací o obrázku (rozměry, velikost, formát, pozice)</li>"
        "<li><b>Zapamatování složky</b> — aplikace si pamatuje poslední otevřenou cestu</li>"
        "<li><b>Otevření z Finderu</b> — přímé otevření souborů kliknutím nebo z Outlooku</li>"
        "</ul>"
        "<h3>Technologie</h3>"
